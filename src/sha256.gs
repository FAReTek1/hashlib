...
# if is_ascii is false, then do not encode the data string.
# if ret_hex is true, then only return hex. otherwise returns a bstr
func sha256(data, is_ascii=true, ret_hex=true) {
    ...
    delete sha256_chunks;
    local chunk = "";
    i = 1;
    repeat length message {
        chunk &= message[i];
        if i % 512 == 0 {
            add chunk to sha256_chunks;
            chunk = "";
        }
        i++;
    }
    ...
    local h0 = "01101010000010011110011001100111";
    local h1 = "10111011011001111010111010000101";
    local h2 = "00111100011011101111001101110010";
    local h3 = "10100101010011111111010100111010";
    local h4 = "01010001000011100101001001111111";
    local h5 = "10011011000001010110100010001100";
    local h6 = "00011111100000111101100110101011";
    local h7 = "01011011111000001100110100011001";
    ...
    repeat length sha256_chunks {
        ...
        i = 16;
        until i == 64 {
            local w1 = sha256_words[i - 14];
            local w14 = sha256_words[i - 1];
            # σ0
            ...
            # w16 = w0 + σ0 + w9 + σ1
            add _hashlib_truncate32(bstr_add(bstr_add(bstr_add(sha256_words[i - 15], st), sha256_words[i - 6]), s1)) to sha256_words;
            i++;
        }
